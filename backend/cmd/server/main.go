...
func main() {
	...
	handler.RegisterInviteRoutes(api, svc)
	handler.RegisterActivityRoutes(api, svc)
	handler.RegisterResponseInterceptionRoutes(api, svc)
	handler.RegisterAdminRoutes(api, svc)
	handler.RegisterAdminInviteRoutes(api, svc)
	handler.RegisterAdminActivityRoutes(api, svc)
	handler.RegisterAdminContentAuditRoutes(api, svc)
