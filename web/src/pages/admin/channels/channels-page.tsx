...
import { ChannelAPIKeyManager } from "../components/channel-api-key-manager";
...
export default function ChannelsPage() {
    ...
    const [managingChannelKeys, setManagingChannelKeys] = useState<ModelChannel | null>(null);
    ...
    if (managingChannelKeys) {
        return <ChannelAPIKeyManager channel={managingChannelKeys} onClose={() => setManagingChannelKeys(null)} onChanged={async () => { await syncChannels(); await reload(); }} />;
    }
